...
const Icon = ({ name, className = '', ...props }) => {
    ...
    const icons = {
        ...
        x: <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 7.184L18.901 1.153zm-1.8 19.5h2.833L7.095 2.542H4.062l13.04 18.11z"/>,
    ...
    if (!iconPath) {
        // İkon bulunamazsa bir placeholder veya hata ikonu döndür
        return (
    ...
    const socialIcons = ['x', 'youtube', 'instagram', 'facebook', 'linkedin', 'whatsapp', 'google'];
    const isSocial = socialIcons.includes(name);
    const isSynara = name === 'synara'; 
    ...
    let svgProps = {
        ...
        height: "24",
        viewBox: "0 0 24 24",
        // KRİTİK İYİLEŞTİRME: className prop'unu en sona ekleyerek 
        // dışarıdan gelen sınıfların (özellikle boyut ve renk) öncelik kazanmasını sağla.
