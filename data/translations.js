...
export const translations = {
    tr: {
                ...
                // --- BİLDİRİM METİNLERİ ---
        // KR[Immersive content redacted for brevity.]
        ...
        // --- HİZMET ŞARTLARI SAYFASI ---
        terms_last_updated: "Son Güncelleme: 27 Ekim 2025",

        terms_section1_title: "Hizmetin Kabulü",
        terms_section1_content: "Synara System (bundan sonra 'Synara' olarak anılacaktır) hizmetlerini kullanarak, bu Hizmet Şartları'nı ve Gizlilik Politikası'nı kabul etmiş sayılırsınız. Bu şartları kabul etmiyorsanız, lütfen hizmetlerimizi kullanmayın.",

        terms_section2_title: "Hesap Sorumluluğu",
        terms_section2_content: "Hizmetlerimizi kullanabilmek için bir hesap oluşturmanız gerekebilir. Hesabınızın ve şifrenizin gizliliğinden siz sorumlusunuz. Hesabınız altında gerçekleşen tüm aktivitelerden yasal olarak siz sorumlusunuz.",

        terms_section3_title: "Fikri Mülkiyet Hakları",
        terms_section3_content: "Synara'nın hizmetleri, yazılımları, içeriği ve tüm materyalleri (metinler, grafikler, logolar, vb.) Synara'ya veya lisans verenlerine aittir ve uluslararası telif hakkı yasalarıyla korunmaktadır. Bu içeriği ticari amaçlarla kopyalayamaz, dağıtamaz veya yeniden üretemezsiniz.",

        terms_section4_title: "Yasaklanmış Kullanım",
        terms_section4_content: "Hizmetlerimizi yasa dışı amaçlarla veya bu Şartları ihlal edecek şekilde kullanmak kesinlikle yasaktır. Buna, diğer kullanıcıları taciz etmek, spam göndermek, zararlı yazılımlar yüklemek veya hizmetin güvenliğini tehlikeye atmak dahildir.",

        terms_section5_title: "Hizmetin Değiştirilmesi ve Sonlandırılması",
        terms_section5_content: "Synara, önceden bildirimde bulunarak veya bulunmaksızın, hizmetlerinin herhangi bir bölümünü değiştirme veya sonlandırma hakkını saklı tutar. Kullanıcının bu Şartları ihlal etmesi durumunda, Synara kullanıcının hizmete erişimini derhal sonlandırabilir.",

        terms_section6_title: "Garantilerin Reddi ve Sorumluluk Sınırlaması",
        terms_section6_content: "Synara hizmetleri 'olduğu gibi' ve 'mevcut olduğu gibi' esasına göre sağlanmaktadır. Synara, hizmetlerin kesintisiz, hatasız veya güvenli olacağına dair herhangi bir garanti vermemektedir. Özellikle finansal analiz araçları yatırım tavsiyesi değildir ve Synara, bunların kullanımından doğacak zararlardan sorumlu tutulamaz. Yürürlükteki yasanın izin verdiği en geniş ölçüde, Synara, kar kaybı, veri kaybı veya diğer dolaylı, arızi, özel, sonuçsal veya cezai zararlardan sorumlu olmayacaktır.",

        terms_section7_title: "Tazminat",
        terms_section7_content: "Bu Şartları ihlal etmenizden veya hizmetleri kötüye kullanmanızdan kaynaklanan her türlü talep, zarar, yükümlülük ve masraftan (avukatlık ücretleri dahil) Synara'yı savunmayı ve tazmin etmeyi kabul edersiniz.",

        terms_section8_title: "Şartlarda Değişiklikler",
        terms_section8_content: "Bu Hizmet Şartları'nı zaman zaman güncelleyebiliriz. Yeni Şartlar bu sayfada yayınlandıktan hemen sonra yürürlüğe girecektir. Değişikliklerden sonra hizmetlerimizi kullanmaya devam etmeniz, güncellenmiş şartları kabul ettiğiniz anlamına gelir.",

        // --- GİZLİLİK POLİTİKASI SAYFASI ---
        privacy_policy_last_updated: "Son Güncelleme: 27 Ekim 2025",
        privacy_policy_title_1: "Topladığımız Bilgiler",
        privacy_policy_content_1: "Hesap oluştururken adınız, e-posta adresiniz gibi kişisel olarak tanımlanabilir bilgileri toplarız. Ayrıca, hizmetlerimizi kullanımınızla ilgili (analiz verileri, cihaz bilgileri, IP adresi vb.) teknik ve anonim verileri de topluyoruz.",
        privacy_policy_title_2: "Bilgileri Nasıl Kullanıyoruz",
        privacy_policy_content_2: "Topladığımız bilgileri hizmetlerimizi sağlamak, geliştirmek, güvenliği sağlamak, hesap yönetimi ve destek için kullanırız. Verileriniz, asla izniniz olmadan üçüncü taraflarla paylaşılmaz veya satılmaz.",
        privacy_policy_title_3: "Veri Güvenliği",
        privacy_policy_content_3: "Bilgilerinizi yetkisiz erişime, değişikliğe, ifşaya veya yok edilmeye karşı korumak için çeşitli güvenlik önlemleri uyguluyoruz. Ancak hiçbir internet iletim yöntemi %100 güvenli değildir.",
        privacy_policy_title_4: "Üçüncü Taraf Bağlantıları",
        privacy_policy_content_4: "Hizmetimiz, bizim tarafımızdan işletilmeyen diğer sitelere bağlantılar içerebilir. Bu üçüncü taraf sitelerin içeriği, gizlilik politikaları veya uygulamaları üzerinde hiçbir kontrolümüz yoktur ve sorumluluk kabul etmeyiz.",
        privacy_policy_title_5: "Çocukların Gizliliği",
        privacy_policy_content_5: "Hizmetlerimiz 18 yaş altındaki hiç kimseye hitap etmemektedir. Bilerek 18 yaş altındaki kişilerden kişisel olarak tanımlanabilir bilgi toplamıyoruz. Bir ebeveyn veya veli iseniz ve çocuğunuzun bize kişisel veriler sağladığını fark ederseniz, lütfen bizimle iletişime geçin.",
        privacy_policy_title_6: "Gizlilik Politikası Değişiklikleri",
        privacy_policy_content_6: "Gizlilik Politikamızı zaman zaman güncelleyebiliriz. Yeni politika bu sayfada yayınlandıktan hemen sonra yürürlüğe girecektir.",
        ...
        // --- MODÜLLER BÖLÜMÜ ---
        modules_section_title: "4 Uzman Modül, 1 Merkezi Karar Motoru",
        ...
        footer_rights: "Tüm hakları saklıdır. Synara System bir Mesteg Teknoloji Markasıdır.",
        ...
        // KRİTİK EKLEME (YASAL METİN BAŞLIKLARI VE İÇERİKLERİ)
        terms_last_updated: "Son Güncelleme: 17 Ağustos 2024",
        terms_section1_title: "Hizmetin Kabulü ve Kapsamı",
        terms_section1_content: "Synara System'i kullanarak, bu Hizmet Şartları'nı ve Gizlilik Politikası'nı kabul etmiş olursunuz. Synara, yalnızca bir teknik analiz aracı olup, yatırım danışmanlığı hizmeti vermez. Kullanıcılar, aldıkları kararların tek sorumlusudur.",
        terms_section2_title: "Abonelik ve Ödeme Protokolleri",
        terms_section2_content: "Abonelikler aylık dönemlerle ücretlendirilir. Tüm modüllere tam erişim, ödeme onayı ile başlar. Abonelik dilediği zaman iptal edilebilir. İptal durumunda mevcut dönemin sonuna kadar erişim devam eder.",
        terms_section3_title: "Kullanım Kısıtlamaları ve Disiplin",
        terms_section3_content: "Kullanıcılar, sistemi sadece kişisel disiplin ve analiz amaçları için kullanabilir. Sinyalleri toplu olarak kopyalamak, paylaşmak veya API'lar aracılığıyla üçüncü partilere iletmek kesinlikle yasaktır. Bu, aboneliğin derhal iptal edilmesine yol açar.",
        terms_section4_title: "Fikri Mülkiyet ve Lisans",
        terms_section4_content: "Synara System, Mesteg Teknoloji LTD. ŞTİ.'nin tescilli fikri mülkiyetidir. Tüm algoritmalar (Anchor TF, HIM, Nexus vb.), kodlar ve görsel tasarımlar telif hakkı ile korunmaktadır. Abonelik, sadece kişisel kullanım lisansı sağlar.",
        terms_section5_title: "Sorumluluğun Reddi",
        terms_section5_content: "Piyasalarda risk her zaman mevcuttur. Synara, hiçbir kar ve zarar garantisi vermez. Sistemin sunumu, kullanıcının bireysel risk yönetimine bir destektir ve nihai karar kullanıcıya aittir.",

        privacy_last_updated: "Son Güncelleme: 17 Ağustos 2024",
        privacy_section1_title: "Toplanan Bilgiler",
        privacy_section1_content: "Platformumuz, sadece hizmetin sunulması ve disiplin takibi için gerekli olan bilgileri toplar: E-posta adresi, şifrenin şifreli hali (Firebase Auth), TradingView kullanıcı adı ve kasa yönetim verileri.",
        privacy_section2_title: "Verilerin Kullanım Amacı",
        privacy_section2_content: "Toplanan veriler sadece abonelik durumunu yönetmek, kişiselleştirilmiş performans analizi (Kokpit) sunmak, Yapay Zeka Asistanı'na bağlamsal bilgi sağlamak ve topluluk içi anonim liderlik tablosu oluşturmak için kullanılır. Verileriniz üçüncü partilerle paylaşılmaz.",
        privacy_section3_title: "Veri Güvenliği Protokolü",
        privacy_section3_content: "Tüm kullanıcı verileri, Firebase/Google Cloud altyapısı üzerinde şifreli olarak saklanır. Sunucu prosedürleri (tRPC), token tabanlı yetkilendirme ile korunur ve yetkisiz erişim kesinlikle engellenir.",
        privacy_section4_title: "Çerezler ve İzleme Teknolojileri",
        privacy_section4_content: "Hizmetin sürekliliği ve temel analitik (Google Analytics / Plausible) için çerezler kullanmaktayız. Çerez onayınız, size gösterilen bildirim ile alınır ve bu durum Firestore'a kaydedilir. Performans ölçümleri anonimleştirilmiş olarak yapılır.",
        privacy_section5_title: "Kişisel Verilerin Silinmesi",
        privacy_section5_content: "Kullanıcılar, diledikleri zaman hesaplarını ve tüm kişisel verilerini (kasa kayıtları dahil) kalıcı olarak silme hakkına sahiptir. Bu talepler için yönetim paneli veya iletişim kanalları kullanılabilir.",
        // KRİTİK EKLEME BİTİŞ
