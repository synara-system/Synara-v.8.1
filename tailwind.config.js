...
module.exports = {
  ...
  // KRİTİK FİX: Dinamik olarak oluşturulan Header ve Glow sınıfları için safelist genişletildi.
  safelist: [
    // --- Synara Neon Glow Sınıfları (Yeni Eklendi) ---
    // Bu sınıflar globals.css'te tanımlanmıştır ve Tailwind'in bunları atmasını engeller.
    'synara-indigo-glow', 'synara-green-glow', 'synara-yellow-glow', 'synara-orange-glow', 'synara-red-glow', 'synara-sky-glow',
