    ...
    return (
        <section className="py-16 bg-gray-900">
            <div className="container mx-auto px-6 text-center">
                ...
                <p className="text-gray-400 mb-12">Ana piyasa seanslarının aktif olduğu &quot;Killzone&quot; saatlerini (TR) saatleri ile takip edin.</p>
                    ...
                    <div className="absolute top-full w-full mt-2">
                         {timeLabels.map(hour => (
                             /* PageSpeed FİX (Erişilebilirlik - Kontrast):
                                ...
                                olarak güncellendi.
                             */
                            <div key={hour} className="absolute -translate-x-1/2 text-xs text-gray-400" style={{ left: `${(hour / 24) * 100}%` }}>
