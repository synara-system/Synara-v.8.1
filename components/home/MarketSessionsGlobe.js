                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p className="text-gray-400 mb-6">
                           Synara, küresel piyasa seanslarını ve likidite avlarını anlık olarak takip eder. Metis modülümüz, piyasa yapıcıların zihniyetiyle hareket ederek sizi her zaman bir adım önde tutar.
                        </p>
                    </div>
