...
import nextDynamic from 'next/dynamic'; // KRİTİK FİX 1: "dynamic" değişkeni yeniden adlandırıldı
...
const AnalysesClient = nextDynamic(() => import('./AnalysesClient.js'), { // KRİTİK FİX 2: nextDynamic olarak kullanıldı
