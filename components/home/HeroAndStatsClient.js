...
// NOT: Bu dosya, 'fix27' sürümündeki 'HeroAndStatsClient.js'nin LCP optimizasyonu uygulanmış halidir.
'use client';
...
const SatelliteNode = ({ name, color, style }) => (
  ...
  <div className="satellite-wrapper" style={style}>
    ...
    <motion.div 
        ...
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 0.5, duration: 0.5 }} // Bu iç elemanın gecikmesi kalabilir
    >
...
export const HeroClient = ({ T }) => {
  ...
  const containerVariants = {
    ...
    visible: {
      transition: {
        ...
        // delayChildren: 0.3, // PageSpeed LCP FİX: Kaldırıldı (veya zaten yoktu)
      },
    },
  };
  ...
  return (
    <section 
        ...
        className="relative bg-gray-900 overflow-hidden pt-20 pb-16 md:pt-10 md:pb-10 mt-10" 
    >
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-7xl text-center">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              {/* PageSpeed FİX (LCP Dökümü - 2.5s Gecikme):
                  LCP elementi olan H1, animasyonlu 'motion.h1' den 
                  statik 'h1' e dönüştürüldü. 'variants' kaldırıldı.
                  Bu, LCP gecikmesini 0'a indirir.
              */}
              <h1 
            ...
            <div className="relative h-[450px] lg:h-[500px] flex items-center justify-center">
              <div className="w-full h-full">
                ...
                {/* PageSpeed LCP FİX (Render Delay): Ana iş parçacığını bloke etmemesi için animasyon başlangıcı geciktirildi. */}
                <motion.div 
                    className="simplified-orbit-container"
                    initial={{ opacity: 0, scale: 0.8 }}
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ duration: 1, delay: 1.5, ease: "easeOut" }} // delay: 0.5 -> 1.5
                >
